import{dy as y,dQ as K,c_ as c,c$ as we,cN as k,cO as H,cR as g,cS as v,cT as d,cQ as l,dg as W,d4 as M,dh as u,cP as ue,cV as X,cs as w,de as q,dL as be,dD as Z,ct as Q,cA as A,d6 as J,cY as ge,cv as z,dR as F,dI as ne,df as ye,cX as he,dS as ve,dT as xe,cu as $e,d0 as ke}from"./index-CzqbII1s.js";import{S as Se}from"./SwapController-Dzg42MdG.js";const pe={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){y.shake();return}if(await K.isSIWXCloseDisabled()){y.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&we.disconnect(),y.close()}},Ce=k`
  :host {
    display: block;
