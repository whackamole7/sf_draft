import { bK as Logger, bL as defineReadOnly, bM as BigNumber, bN as VERSION, bO as EthersNetwork, bP as __awaiter$1, bQ as noop$1, bR as CustomNetworks, bS as getNetwork, bT as isAlchemyEvent, bU as verifyAlchemyEventName, bV as EthersEvent, bW as getAlchemyEventTag, bX as ALCHEMY_EVENT_TYPES, bY as DEFAULT_ALCHEMY_API_KEY, bZ as ALCHEMY_PENDING_TRANSACTIONS_EVENT_TYPE, b_ as AlchemySubscription, b$ as ALCHEMY_MINED_TRANSACTIONS_EVENT_TYPE, c0 as fromHex, c1 as toHex } from "./index-BO0YjtMl.js";
import { v as version, J as JsonRpcProvider, A as AlchemyProvider } from "./alchemy-provider-2577f5a5-Bdl5ulog.js";
let WS = null;
try {
  WS = WebSocket;
  if (WS == null) {
...
const HEARTBEAT_WAIT_TIME = 1e4;
const BACKFILL_TIMEOUT = 6e4;
